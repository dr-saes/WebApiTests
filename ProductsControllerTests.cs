...
namespace WebApi_AspNet_Core.Tests
{
    ...
    public class ProductsControllerTests
    {
        ...
        //DeleteProduct()  - _context not null and product not null
        [Fact]
        public async Task DeleteProductById_ProductsNotNull_ReturnNoContent204()
        {
            // Arrange
            var options = new DbContextOptionsBuilder<ApiDbContext>()
                .UseInMemoryDatabase(databaseName: "TestDatabase")
            ...
            using (var _context = new ApiDbContext(options))
            {
                ...
                // Act
                var result = await productsController.DeleteProduct(id);
